    ...
    <div className='about' id='about'>
        <div className='row'>
            ...
            <div className='col-md-6 col-xl-6 col-lg-6 col-xs-12 about-content'>
                ...
                My journey in technology began at Mehr Chand Polytechnic College, where I completed my PSBTE & IT (LEET) in Computer Science & Engineering Honours with an impressive 76.6%, This educational milestone not only laid a solid foundation but also served as a catalyst for the subsequent chapters of my professional endeavors.<br/><br/>
